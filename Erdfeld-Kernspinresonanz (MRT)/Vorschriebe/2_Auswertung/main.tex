...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=8cm]{../Bilddateien/Exp1_Parameter.PNG}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.4\textwidth}
            \includegraphics[width=6cm]{../Bilddateien/Exp1_FID.png}
            \caption{FID Signal des ersten Durchgangs.}
            \label{fig:2:FID1}
        \end{subfigure}
        \
        \begin{subfigure}[b]{0.4\textwidth}
            \includegraphics[width=6cm]{../Bilddateien/Exp2_FID.png}
